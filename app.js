...
const getChina = () => {
  ...
  menu.map((item) => {
    if (item.category === "chineseFoods") {
      chineseFoods += postFoods(item)
    }
  })
  menuList.innerHTML = chineseFoods
}

// Activation of buttons and showing foods

const btnAll = document.querySelector("#all")
const btnKorea = document.querySelector("#korea")
const btnJapan = document.querySelector("#japan")
const btChina = document.querySelector("#china")

btnAll.addEventListener("click", getFood)
